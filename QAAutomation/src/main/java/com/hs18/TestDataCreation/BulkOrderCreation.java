...
//		try
//		{
//		String gc =read.readFromColumn("BulkOrder", 1, 9);
//		bulk.setGcNumber(gc);
//		}
...
//		}
		...
		bulk.setOrderId(orderid);
			...
			read.writeExcelFromWeb(suborderlist,"Suborder", 0, path);
	...
	public Object[][] dataProviderForY() throws IOException {
		read.testDataFile("E:\\Projects\\HS18Automation\\UIAutomation\\QAAutomation\\TestFile\\TestDataCreation.xls");
		Object[][] data = null;

		data = 
				new Object[][] { { read.readFromColumn("BulkOrder", 1, 0), read.readFromColumn("BulkOrder", 1, 1),
